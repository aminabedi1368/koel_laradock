    ...
    <div class="main-scroll-wrap">
      ...
      <div class="preferences">
        ...
        <div class="form-row">
          <label>
            ...
            Confirm before closing Gramatune
          </label>
        </div>
        <div class="form-row">
          <label>
      ...
      <section class="lastfm" >
        ...
        <div v-if="sharedState.useLastfm">
          <p>This installation of Gramatune integrates with Last.fm.
          ...
          <p>
            Connecting Gramatune and your Last.fm account enables exciting features – scrobbling is one of them.
          </p>
          <p v-if="state.current.preferences.lastfm_session_key">
            ...
            Doing so will reload Gramatune, though.
          </p>
        ...
        <div v-else>
          <p>This installation of Gramatune has no Last.fm integration.
            <span v-if="state.current.is_admin">Visit
              <a href="https://gramatune.com" target="_blank">Gramatune’s Wiki</a>
              for a quick how-to.
            </span>
